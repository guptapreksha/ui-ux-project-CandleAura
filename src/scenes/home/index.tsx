        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-5 text-sm">
              Welcome to CandleAura — where craftsmanship meets calm.
              Explore hand-poured candles designed to elevate your space with soothing scents
              and warm ambiance. Light up your moments with elegance and intention.
            </p>
          </motion.div>
          {/* ACTIONS */}
          <motion.div
